export const Bio = {
   ...
   
    {
      ...
      skills: [
        ...
        },
        {
          name: "Figma",
          image:
          "https://upload.wikimedia.org/wikipedia/commons/thumb/3/33/Figma-logo.svg/64px-Figma-logo.svg.png"
        },
      ],
    },
  ];
  ...
  export const projects = [

    {
      ...
      description:
      "Developed a full-stack chat application enabling real-time messaging with features such as user authentication, private messaging, and group chats. Implemented Google Auth and JWT Auth for secure user authentication. Created a responsive user interface using React JS, ensuring a seamless experience across all devices. Utilized Socket.io for real-time updates and followed agile methodologies to enhance team efficiency and communication.",
      image:
        "https://github.com/user-attachments/assets/7663b857-de7e-48f3-a588-7f6cc1bb4211",
    ...
    },
    {
      ...
      date: " Feb 2024",
      description:
       " Developed a calculator app using ReactJS that supports basic arithmetic operations including addition, subtraction, multiplication, and division. Designed a user-friendly interface with buttons for each function and display for showing results. Implemented state management to handle input and computation, ensuring real-time updates and accurate calculations. The app features a responsive design for seamless use on various devices. ",

      image:
        "https://github.com/user-attachments/assets/3b0f8040-2214-48de-b6bb-f51108ab3081",
      tags: ["React Js", "Local Storage", "AWS Auth", "Node JS"],
      category: "web app",
      github: "https://github.com/Sravansky15/Calculator",
      webapp: "https://calculator-a-five.vercel.app/",
    },
